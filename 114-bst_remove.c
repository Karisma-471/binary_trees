...
/**
 * inorder_successor - A func that returns the minimum value
...
/**
 * bst_delete - A func that deletes a node from a binary search tree.
...
/**
 * bst_remove_recursive - A func that removes a node
 ...
 * @root: A pointer that points to the root node 
 * of the BST to remove a node from.
