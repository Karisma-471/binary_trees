...
/**
 * binary_tree_levelorder - A func that goes through a binary tree
...
/**
 * levels_rec - Calling a func on all nodes at each level.
...
/**
 * get_children - Appends the children of parent to linked list.
...
/**
 * append - Adding a new node at the end of a linkedlist
...
/**
 * free_list - free all the nodes in a linked list
